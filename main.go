...
import (
	"context"
	dpfm_api_caller "data-platform-api-business-partner-exconf-customer-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-business-partner-exconf-customer-rmq-kube/config"
...
func dataCallProcess(
	...
	out.BusinessPartnerCustomer = *exist
	l.JsonParseOut(out)
}
